...
public class StudentCourseRegistrationSystem {
    public static void main(String[] args) {
        ...
        studentDatabase.addStudent(new Student("1001", "Darshana Patil"));
        studentDatabase.addStudent(new Student("1002", "Rahul Trivedi"));
        studentDatabase.addStudent(new Student("1003", "Hana Thomas"));
        studentDatabase.addStudent(new Student("1004", "Vaishali Chaudhari"));
        studentDatabase.addStudent(new Student("1005", "San Choi"));
        studentDatabase.addStudent(new Student("1006", "Lily Clark"));
        studentDatabase.addStudent(new Student("1007", "Tina Mhatre"));
        studentDatabase.addStudent(new Student("1008", "Bella Lewis"));
        studentDatabase.addStudent(new Student("1009", "Janvhi Bendale"));
        studentDatabase.addStudent(new Student("1010", "Soumya Mhahajan"));
        studentDatabase.addStudent(new Student("1011", "Vivan Narkhede"));
        studentDatabase.addStudent(new Student("1012", "Alexa Park"));
        studentDatabase.addStudent(new Student("1013", "Ribecca John"));
        studentDatabase.addStudent(new Student("1014", "Tom Lee"));
        studentDatabase.addStudent(new Student("1015", "Junu Oh"));
        studentDatabase.addStudent(new Student("1016", "Yubin Kim"));
        studentDatabase.addStudent(new Student("1017", "Kevin L"));
        studentDatabase.addStudent(new Student("1018", "Eric Nam"));
        studentDatabase.addStudent(new Student("1019", "Deepak Chopra"));
        studentDatabase.addStudent(new Student("1020", "Anna Catherate"));
